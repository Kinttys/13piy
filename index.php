...
<body>
    ...
    <!-- Footer -->
      <small class="pb-3 d-block my-auto footer-copyright text-secondary text-center py-4 w-100">©  Copyright 2022 Website By <a href="" target="_blank">PIYAWATSHOP</a> All Rights Reserved.</small>
    <!-- End Footer -->
    </div>
    <!-- Container End -->
