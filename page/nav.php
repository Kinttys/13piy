    <nav class="navbar navbar-expand-md navbar-light bg-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          ...
          <div class="form-inline my-2 my-lg-0">
            ...
            <a href="https://www.facebook.com/F0x.Ss/" target="_blank"><button class="btn btn-sm hyper-btn-primary my-2 my-sm-0 mr-3" type="button"><i class="fab fa-facebook-square mr-1"></i> Facebook</button></a>
          </div>
        </div>
    </nav>