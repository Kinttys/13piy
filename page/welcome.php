        ...
        <div class="media">
            ...
            <div class="media-body">
              <div class="mt-0 d-none d-lg-block">
                  <h1 class="mt-0 mb-1"><b><?= strtoupper($webname) ?></b> เว็บไซต์บริการจำหน่ายไอดี ส้มตำ กวาง หยก และอื้่นๆๆ</h1>
<pre>
<?= $webdetail; ?>
</pre>
              </div>
              <div class="d-block d-lg-none"><h1 class="mt-0 mb-2"><b><?= strtoupper($webname) ?></b></h1><h4> เว็บไซต์บริการจำหน่ายไอดี ส้มตำ กวาง หยก และอื้่นๆๆ</h4></div>
